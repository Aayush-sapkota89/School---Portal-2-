      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We'd love to hear from you. Contact us for admissions, inquiries, or any other information
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    info@balbatikaschool.edu.np<br />
                    admission@balbatikaschool.edu.np
                  </p>
                </div>
              </div>
          ...
          <div>
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-700 text-white py-4 rounded-lg font-semibold hover:bg-blue-800 transition-colors duration-300 flex items-center justify-center gap-2"
              >
                Send Message
